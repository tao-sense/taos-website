          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg">
                ...
                into deliciously slow and sensual touch of the whole body, no part of you is
                excluded or shamed. Every gesture is offered with devotion, honouring the
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-black/80">
                ...
                <li>
                  ...
                  ceremony, moving into deliciously slow, full-body massage supported by
                  intuitive touch, breathwork, and energetic awareness.
                </li>
                <li>
                ...
                <li>
                  ...
                  container with soothing music, warmth and soft lighting.
                </li>
              </ul>
            </div>
            <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg">
      ...
      <ScrollFade delay={0.2}>
        <section className="bg-white text-black py-20 px-6 border-t border-gray-200">
          ...
          <div className="max-w-3xl mx-auto text-lg space-y-4">
            ...
            <p>
              I currently offer 1-to-1 Tantra Massage sessions for women only. This boundary
              allows me to hold a space that remains aligned with the nature of my work and my
              personal experience in this field. I do offer a service for couples (where at least
            ...
            <p>
              ...
              free to express, pause, or stop at any point during the massage. Your comfort,
              consent, and inner safety remain at the heart of the practice.
            </p>
          </div>
        </section>
      </ScrollFade>
        ...
        <section className="bg-black py-20 px-6 text-center border-t border-white/10">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-white/80 text-lg">
              ...
              our bodies. Tantra Massage is an opportunity to soften those layers and return
              to the simple beauty of being touched — with presence, honour, and care.
            </p>
          </div>
        </section>
      </ScrollFade>
        ...
        <section className="bg-white text-black px-6 py-20 text-center border-t border-gold/30">
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-lg text-black/80">
              ...
              space in Stroud, Gloucestershire.
            </p>
          ...
          <div className="bg-white py-12 px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-semibold text-black mb-6">
              Ready to experience Tantra Massage?
            </h2>
            <Link
              href="/contact"
