        ...
        <section className="bg-white text-black">
          <div className="flex justify-center mb-10 pt-20">
            <Image
              ...
              alt="Decorative gold swirl divider – TAOS Intimacy Coaching"
              width={200}
              height={60}
          ...
          <div className="max-w-4xl mx-auto px-6 pb-20 space-y-6 text-center">
            <p className="text-black/80 leading-relaxed text-lg">
              <strong className="text-gold">
                Intimacy Coaching with The Art of Sensuality (TAOS)
              </strong>{" "}
              is a guided, experiential approach designed to help individuals
              and couples explore a more conscious, connected, and fulfilling
              experience of sensuality and intimacy. It is{" "}
            ...
            <p className="text-black/80 leading-relaxed text-lg">
              ...
              <span className="text-gold">Tantra massage</span>, you’ll learn to
              slow down, listen, and rediscover the joy of touch and connection
              — free from pressure or performance. These sessions are available
              in Stroud and online across the UK.
            </p>
      ...
      <ScrollFade>
        <section className="bg-black-100 text-white">
          <div className="flex justify-center mb-10 pt-20">
            <Image
              src="/images/swirl-divider.png"
              alt="Decorative gold swirl divider – Working with Couples at TAOS"
              width={200}
              height={60}
          ...
          <div className="max-w-5xl mx-auto px-6 pb-20 space-y-10 text-center">
            ...
            <p className="text-white/80 leading-relaxed text-lg max-w-3xl mx-auto">
              There are two main ways couples can work with TAOS. You may wish
              to begin with{" "}
              <Link href="#couples-coaching" className="text-gold hover:underline">
                Intimacy Coaching sessions
              </Link>{" "}
              — a gentle, conversational exploration of Tantra-inspired
              principles, or immerse yourselves more deeply through the{" "}
              <Link href="#couples-training" className="text-gold hover:underline">
                Tantra Massage Training for Couples
              </Link>{" "}
              — a structured and hands-on learning journey. Both are designed to
              restore trust, connection, and playfulness through presence rather
              than performance.
            </p>
          </div>
        </section>
      ...
      <ScrollFade>
        ...
        >
          <div className="flex justify-center mb-10">
            <Image
              src="/images/swirl-divider.png"
              alt="Decorative gold swirl divider – Intimacy Coaching for Couples"
              width={200}
              height={60}
              className="h-12 md:h-16 w-auto"
            />
          ...
          <div className="max-w-5xl mx-auto space-y-10 text-center">
            ...
            <p className="max-w-3xl mx-auto text-lg leading-relaxed text-black/80">
              ...
              emotional connection. These sessions provide a safe, guided space
              to explore the{" "}
              <strong className="text-gold">
                principles of Tantra and conscious touch
              </strong>{" "}
            ...
            <p className="max-w-3xl mx-auto text-base text-black/70 leading-relaxed pt-6">
              These sessions are ideal for couples curious about Tantra and
              intimacy coaching who wish to strengthen connection without
              learning the full massage ritual.
            </p>
      ...
      <ScrollFade>
        ...
        >
          <div className="flex justify-center mb-10">
            <Image
              src="/images/swirl-divider.png"
              alt="Decorative gold swirl divider – Intimacy Coaching for Individuals"
              width={200}
              height={60}
              className="h-12 md:h-16 w-auto"
            />
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <p className="text-lg leading-relaxed">
              ...
              awareness. Available in Stroud and online across the UK, these
              sessions may include breathwork, mindfulness, and guided
              touch-based learning within agreed boundaries.
            </p>
            <p className="text-lg leading-relaxed">
              Many people seek this work to navigate experiences such as:
            </p>
