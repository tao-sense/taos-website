      ...
      <section className="relative w-full text-center overflow-hidden bg-[#f3d08b]">
        ...
        <div className="block md:hidden relative w-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-6 space-y-4">
            <ScrollFade>
              <h1 className="text-4xl font-bold text-white/90">My Journey</h1>
            </ScrollFade>

            <ScrollFade delay={0.1}>
              <p className="text-lg text-white/85 max-w-2xl mx-auto">
                A path toward connection, love, and an open heart.
              </p>
            </ScrollFade>
        ...
        <div className="hidden md:block relative w-full h-[90vh] lg:h-[90vh]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-6 space-y-4">
            <ScrollFade>
              <h1 className="text-5xl lg:text-6xl font-bold text-white/90">
                My Journey
              </h1>
            </ScrollFade>
          ...
          <div className="max-w-3xl mx-auto space-y-10 text-lg leading-relaxed">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-10">
              <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-gold shadow-lg">
                <Image
                  ...
                  alt="Wesley Tan – Founder of TAOS"
                  width={160}
                  height={160}
              ...
              <div className="text-center md:text-left space-y-1">
                ...
                <p className="text-black/80 max-w-lg">
                  ...
                  reconnect with their bodies through movement, awareness, and
                  touch. TAOS is the synthesis of this lifelong journey — blending
                  science, presence, and sensuality into a path of healing and
                  connection.
                </p>
              </div>
            </div>
            ...
            <ScrollFade>
              <div className="space-y-4">
                ...
                <p>
                  My path into bodywork and conscious healing began long before I
                  ever heard the word “Tantra.”
                </p>
                <p>
                ...
                <p>
                  ...
                  — I felt a strong pull to deepen my understanding. This led me to
                  study osteopathy from 2003 to 2007.
                </p>
              </div>
            </ScrollFade>
            ...
            <ScrollFade delay={0.1}>
              <div className="space-y-4">
                ...
                <p className="bg-gold/10 border-l-4 border-gold p-4 italic rounded-md">
                  Yet I often encountered something beyond what these frameworks
                  could fully embrace:{" "}
            ...
            <ScrollFade delay={0.2}>
              <div className="space-y-4">
                ...
                <p>
                  Alongside this professional path, my life with my wife Claire and
                  our two sons has been central. Together, we’ve built our private
                  practice and explored relationship models that invite honesty,
                  reflection, and growth — experiences that continue to deepen my
                  understanding of intimacy and authentic connection.
                </p>
                <p>
                  ...
                  <span className="font-semibold text-black">conscious presence</span>,
                  non-judgmental connection, and authentic human touch. It invited me
                  to slow down, to listen not only with my hands but with my whole
                  being.
                </p>
                <p>
                  I realised that <span className="italic">loving touch</span> —
                  something that sounds so simple — is, for many of us, an enigma. We
                  long for it, yet we’re rarely shown how to give or receive it
                  without expectation, agenda, or fear. This experience shifted my
                  understanding of intimacy, of boundaries, and of what true healing
                  can feel like when presence and acceptance are at the centre.
                </p>
                <p>
                  ...
                  . This immersion gave me the clarity to answer the question I had
                  been sitting with since my trainig with Spiritual Tantra:{" "}
                  <span className="font-semibold text-black">
            ...
            <ScrollFade delay={0.3}>
              <div className="space-y-4">
                ...
                <p>
                  ...
                  Their progress and encouragement gave me the confidence to share
                  this work more openly.
                </p>
                <p className="italic text-gold/80">
                  This path is not about quick fixes. It is about reconnection — to
                  your body, your emotions, your sensuality, and ultimately, to your
                  deeper self.
                </p>
              </div>
            </ScrollFade>
        ...
        <section className="bg-black text-white px-6 py-16">
          ...
          <div className="max-w-3xl mx-auto space-y-8 text-lg leading-relaxed">
            ...
            <p>
              ...
              recognises sexual energy not as something to repress or exploit, but
              as a potent force for{" "}
            ...
            <p>
              In the late 20th century, Tantra began influencing Western
              spirituality through Neo-Tantra movements, which embraced sensuality,
              presence, and intimacy. In Germany,{" "}
              ...
              , where he developed a ceremonial and deeply healing form of
              full-body massage known as{" "}
            ...
            <p>
              This approach wove together ritual, energy work, slow conscious
              touch, and emotional release — offering clients a safe space to
              reconnect beyond shame or conditioning. Today, Germany remains a hub
              for Tantra Massage education, with respected institutions such as{" "}
              <strong className="text-gold font-semibold">Diamond Lotus</strong>,{" "}
              <strong className="text-gold font-semibold">AnandaWave</strong>, and
              the{" "}
              <strong className="text-gold font-semibold">
            ...
            <p className="italic text-gold/80">
              At its heart, Tantra Massage is guided by principles of consent,
              presence, and deep listening — an invitation to awaken not only the
              body, but the soul.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white text-black px-6 py-16 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-lg text-black/80">
              Explore our offerings and discover how Tantra massage can support you
              in reconnecting with your body, your emotions, and your deeper self.
            </p>
            <Link
              href="/offerings"
