...
export default function ClientWorkshopReply({ name }: { name: string }) {
  return (
    <div
      style={{
    ...
    >
      ...
      <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
        ...
        <br />
        <br />
        Your enquiry has been received. Thank you for your interest in joining
        our workshop — we’ll be in touch soon to confirm your place and share
        next steps.
      </p>
